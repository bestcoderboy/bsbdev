export default function ProjectItem(
    { logo, header, description, link }:
    { logo: string | false, header: string, description: string, link: string | false }
) {
    return (
        <div className="flex items-center gap-5 bg-white/5 rounded-md px-5 py-3">
            ...
            <div>
                ...
                {link ?
                    ...
                    <p className="text-white/70 text-sm mt-0.5">available on request -&gt;</p>
                }
            </div>
        </div>
    );
